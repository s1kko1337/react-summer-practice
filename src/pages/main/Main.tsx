            ...
            <div className="main-container">
                <div className="parent">
                    ...
                    <div className="card logo-section div8">
                        <div className="slogan">Присоединяйся <span className="red-text" >сегодня</span> и начинай <span className="red-text">побеждать!</span></div>
                    </div>
                    ...
                    {/* Slider Section - div12 */}
                    <div className="card slider-section div12">
